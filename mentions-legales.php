...
<head>
    ...
    <title>Mentions légales — Paul Leroy</title>
</head>
<body class="legal-page">
    <header class="legal-page__header">
        <a href="index.php" class="legal-page__back" id="legal-back">← Retour au portfolio</a>
    </header>

    <main class="legal-page__main">
        <article class="legal-content">
            <p>La société Paul Leroy est, soucieuse des droits des individus, notamment au regard des traitements automatisés et dans une volonté de transparence, a mis en place une politique reprenant l’ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d’actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits. Pour toute information complémentaire sur la protection des données personnelles, nous vous invitons à consulter le site <a href="https://www.autoriteprotectiondonnees.be/" target="_blank" rel="noopener noreferrer">https://www.autoriteprotectiondonnees.be/</a></p>
            ...
            <ol>
                <li>Site : leroypaul.be</li>
                <li>Hébergeur : Leroypaul.be<br>Leroypaul.be est hébergé par O2switch.fr, dont le siège social est situé à Clermont-Ferrand</li>
            </ol>
            ...
            <ul>
                <li>le droit d’accès : ils peuvent exercer leur droit d'accès, pour connaître les données personnelles les concernant, en écrivant à l'adresse électronique suivante info.epse.be. Dans ce cas, avant la mise en œuvre de ce droit, la Plateforme peut demander une preuve de l'identité de l'utilisateur afin d'en vérifier l'exactitude ;</li>
            ...
            <p>Pour plus d’informations sur l’utilisation, la gestion et la suppression des « cookies », pour tout type de navigateur, nous vous invitons à consulter le lien suivant : <a href="https://www.autoriteprotectiondonnees.be/citoyen/themes/internet/cookies" target="_blank" rel="noopener noreferrer">https://www.autoriteprotectiondonnees.be/citoyen/themes/internet/cookies</a></p>
            ...
            <p>Tout litige en relation avec l’utilisation du site <a href="https://www.epse.be" target="_blank" rel="noopener noreferrer">https://www.epse.be</a> y est soumis au droit belge. En dehors des cas où la loi ne le permet pas, il est fait attribution exclusive de juridiction aux tribunaux compétents de Belges.</p>

            <h2>Contactez-nous</h2>
            <p>Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l'adresse suivante : <a href="mailto:leroypaul.design@gmail.com">leroypaul.design@gmail.com</a></p>
        </article>
    </main>

    <script>
        document.getElementById('legal-back').addEventListener('click', (event) => {
